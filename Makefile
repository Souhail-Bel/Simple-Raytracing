...
CFLAGS 		:= -Wall -Wextra -pedantic -std=c++11 -I$(INCLUDE_DIR) -fopenmp -Wno-unused-parameter -Wno-unused-but-set-variable
CFLAGS		:= $(CFLAGS) -O3 -ffast-math -funsafe-math-optimizations
